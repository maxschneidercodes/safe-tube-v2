export default function Donate() {
    return <div className="ml-4 mt-4 mb-4 p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-slate-800 dark:border-gray-700"
        style={{ width: "420px" }}
        data-aos="fade-up"
        data-aos-delay={`100`}>
        <div className="flex">
            ...
            <a href="#">
                <h5 className="mb-2 text-2xl font-semibold tracking-tight text-white ">SafeTube unterstützen</h5>
            </a>
        </div>
