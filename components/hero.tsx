...
export default function Hero() {
  return <section className="relative pb-10 bg-slate-900">
    <div
      className="absolute inset-0 rounded-bl-[200px] md:mb-0 bg-slate-100 pointer-events-none z-0"
      aria-hidden="true"
    />
      ...
      <div className="pt-10 pb-20 md:pt-20 md:pb-20">
        <div className="relative max-w-xl mx-auto md:max-w-none text-center md:text-left">
          <div className="md:w-[600px]">
            <h1 className="h2 text-[#0f172a] text-left mb-6 mr-10" data-aos="fade-right" data-aos-delay="100">
            ...
            <p className="text-sm text-left text-gray-500 mt-10 mb-10 mr-10" data-aos="fade-right" data-aos-delay="200">
          ...
          <div className="max-w-sm mx-auto md:max-w-none md:absolute md:left-[600px] md:top-0 -mb-12 md:-mt-12 md:mb-0">
            <div className="relative -ml-3 -mr-24 md:mx-0">
              <Image src={HeroImage} unoptimized={true}
                ...
                width="1020" height="545" alt="Credit card" data-aos="fade-up" />
            </div>
          </div>
        </div>
      </div>
