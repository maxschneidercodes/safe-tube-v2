...
export default function Hero() {
  return (
    <section className="relative mb-40">
      <div
        className="absolute inset-0 rounded-bl-[100px] md:mb-0 bg-red-500 pointer-events-none -z-10"
        aria-hidden="true"
      />
        ...
        <div className="pt-10 pb-20 md:pt-20 md:pb-20">
          <div className="relative max-w-xl mx-auto md:max-w-none text-center md:text-left">
            <div className="md:w-[600px]">
              ...
              <h1 className="h2 text-dark text-left mb-6" data-aos="fade-right" data-aos-delay="100">
                YouTube {' '}
              ...
              <p className="text-md text-left text-dark mt-10 mb-4 " data-aos="fade-right" data-aos-delay="200"
                style={{ width: "450px" }}>
                Füge deine Lieblings YouTube-Channels hinzufügen und schau dir die Videos ohne Ablenkung oder unangemessene Inhalte.
              </p>
              <div
            ...
            <div className="max-w-sm mx-auto md:max-w-none md:absolute md:left-[600px] md:top-0 -mb-12 md:-mt-12 md:mb-0">
              <div className="relative -ml-3 -mr-24 md:mx-0">
                <Image src={HeroImage} className="rounded md:max-w-none shadow-2xl" width="1248" height="545" alt="Credit card" data-aos="fade-up" />
              </div>
            </div>
          </div>
        </div>
