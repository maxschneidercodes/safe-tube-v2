  ...
  return (
    <>
      <div className="container p-4 text-light">
        ...
        Vertretungsberechtigte Personen: <p>Max Schneider</p>
        E-Mail-Adresse:{" "}
        <p>
          <a href="mailto:maxschneidercodes@gmail.com">
            maxschneidercodes@gmail.com
          </a>
        </p>
        Impressum:{" "}
        <p>
          <a href="https://www.safetube.eu/imprint/" target="_blank">
            https://www.safetube.eu/imprint/
          </a>
        </p>
        ...
        <p>
          ...
          ihres Browsers erklären, z.B. durch Deaktivierung der Verwendung von
          Cookies (wobei dadurch auch die Funktionalität unserer Online-Dienste
        ...
        <ul className="m-elements">
          ...
          <li>
            ...
            Cookies); Marketing; Profile mit nutzerbezogenen Informationen
        ...
        <ul className="m-elements">
          <li>
            ...
            nutzen den Dienst Google Adsense mit personalisierten Anzeigen, mit
            dessen Hilfe innerhalb unseres Onlineangebotes Anzeigen eingeblendet
            werden und wir für deren Einblendung oder sonstige Nutzung eine
            Entlohnung erhalten; <strong>Dienstanbieter:</strong> Google Ireland
            ...
            ; <strong>Weitere Informationen:</strong> Arten der Verarbeitung
          ...
          <li>
            ...
            ; <strong>Weitere Informationen:</strong> Types of processing and
            data processed:{" "}
            <a
              href="https://privacy.google.com/businesses/adsservices"
              target="_blank"
        ...
        <ul className="m-elements">
          ...
          <li>
            ...
            letzten Wiedergabestelle), gespeichert werden;{" "}
            <strong>Dienstanbieter:</strong> Google Ireland Limited, Gordon
            House, Barrow Street, Dublin 4, Irland;{" "}
            <strong>Rechtsgrundlagen:</strong> Berechtigte Interessen (Art. 6
            Abs. 1 S. 1 lit. f) DSGVO); <strong>Website:</strong>{" "}
        ...
        <h2>Vercel (Notwendig + Cookies)</h2>
        <p>
          Diese Webseite nutzt den Dienst Vercel. Der Anbieter ist Vercel Inc.,
          340 S Lemon Ave #4133, Walnut, CA 91789, USA. Vercel ist eine
          ...
          Webseite verbundenen Daten werden auch an Vercel übermittelt. Dies ist
          notwendig, damit Deine Browseranfrage erfolgreich bearbeitet werden
          kann. Diese Daten umfassen: den Browser-Typ/-Version, das verwendete
          Betriebssystem, die Referrer-URL (die zuvor besuchte Seite), die
          IP-Adresse, die Uhrzeit der Serveranfrage Cookies Diese Daten werden
          je nach Serverstandort auch in die USA übertragen. Wir haben mit
          Vercel einen Vertrag über die Auftragsverarbeitung abgeschlossen.
          Außerdem ist Vercel unter dem EU-US Datenschutzabkommen zertifiziert
          und damit verpflichtet, den EU-Datenschutzvorgaben nachzukommen. Die
          Datenschutzerklärung von Vercel finden Sie
          <a href="https://vercel.com/legal/privacy-policy.">Hier</a>
          Die Datenverarbeitung erfolgt auf Grundlage von Art. 6 Abs. 1 lit. f
          DSGVO. Die Datenübermittlung ist notwendig, damit Sie unsere Webseite
          benutzen können.
        </p>
        <p className="seal">
          <a
